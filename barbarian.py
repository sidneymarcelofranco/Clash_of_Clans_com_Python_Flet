...
def main(page: ft.Page):
    ...
    info = ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ft.Text(value='LEVEL 4', color=ft.colors.ORANGE, weight=ft.FontWeight.BOLD,size=12),
                ft.Text(value='The Barbarian',
                        weight=ft.FontWeight.BOLD,
                        size=30,
                        color=ft.colors.BLACK),
                ft.Text(value='The Barbarian is a kilt-clad Scottish warrior with an angry, battle-ready expression, hungry for destruction. He has Killer yellow horseshoe mustache.',
